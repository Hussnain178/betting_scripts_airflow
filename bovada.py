import json
from helper import parse_tipico_date, normalize_timestamp_for_comparison, compare_matchups, check_key, check_header_name
import scrapy
import re
                            ...
                            for market_data in group_data['markets']:
                                if market_data['outcomes']:
                                    ...
                                    if check_key_name:
                                        ...
                                        sub_key_name = check_header_name(name)
